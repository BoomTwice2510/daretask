...
export default function Legal() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-slate-900">
      ...
      <div className="pointer-events-none absolute -top-24 -left-20 h-96 w-96 rounded-full bg-gradient-to-br from-rose-100/20 via-blue-100/15 to-transparent blur-3xl animate-drift" />
      <div
