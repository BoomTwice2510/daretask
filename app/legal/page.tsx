    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-8 flex flex-col gap-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-red-500/50 bg-red-500/10 px-3 py-1 text-xs text-red-300 backdrop-blur-md">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1
                ...
                style={{
                  background: "linear-gradient(to right,#fca5a5,#fecaca,#fee2e2)",
        ...
        <section className="space-y-5">
          ...
          <div className="rounded-2xl border border-[rgba(212,175,55,0.35)] bg-[rgba(5,5,5,0.96)] p-5 hover:border-[rgba(245,213,102,0.8)] hover:bg-black transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(245,213,102,0.12)]">
                <ScrollText className="h-5 w-5 text-[#f5d566]" />
              </div>
              <h2 className="text-lg font-semibold text-white">On‑chain, immutable rules</h2>
            </div>
          ...
          <div className="rounded-2xl border border-[rgba(212,175,55,0.35)] bg-[rgba(5,5,5,0.96)] p-5 hover:border-[rgba(245,213,102,0.8)] hover:bg-black transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(245,213,102,0.12)]">
                <Scale className="h-5 w-5 text-[#f5d566]" />
              </div>
              <h2 className="text-lg font-semibold text-white">No custody, no legal advice</h2>
            </div>
            <p className="text-sm text-white/75">
          ...
          <div className="rounded-2xl border border-[rgba(212,175,55,0.35)] bg-[rgba(5,5,5,0.96)] p-5 hover:border-[rgba(245,213,102,0.8)] hover:bg-black transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(245,213,102,0.12)]">
                <AlertTriangle className="h-5 w-5 text-[#f5d566]" />
              </div>
              <h2 className="text-lg font-semibold text-white">Volatility and loss of funds</h2>
            </div>
            <p className="text-sm text-white/75">
