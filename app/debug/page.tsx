    ...
    <main className="min-h-screen bg-black text-white px-4 pb-8 pt-4">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="space-y-4">
          {/* RPC Status */}
          <Card className="p-4 border-neutral-800 bg-neutral-950">
          ...
          <Card className="p-4 border-neutral-800 bg-neutral-950">
            ...
            <pre className="text-xs bg-neutral-900 p-3 rounded border border-neutral-800 overflow-auto max-h-48 text-gray-200">
              {JSON.stringify(
                {
                  rpcWorking,
                  contractExists,
