...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-[28px] border border-slate-200/85 bg-white/90 text-slate-900 shadow-[0_8px_30px_rgba(15,23,42,0.04)] backdrop-blur-2xl transition-all duration-300 hover:border-blue-200/80 hover:shadow-[0_12px_36px_rgba(0,82,255,0.07)]',
      className,
    )}
    {...props}
  />
